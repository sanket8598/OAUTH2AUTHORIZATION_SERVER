...
import ai.rnt.auth2.server.repository.AuthorizationRepository;

public class OAuthorizationService implements OAuth2AuthorizationService {

	private final AuthorizationRepository authorizationRepository;
	private final RegisteredClientRepository registeredClientRepository;
	private final ObjectMapper objectMapper = new ObjectMapper();

	public OAuthorizationService(AuthorizationRepository authorizationRepository,
		...
		ClassLoader classLoader = OAuthorizationService.class.getClassLoader();
	...
	private OAuth2Authorization toObject(Authorization entity) {
		...
		OAuth2Authorization.Builder builder = OAuth2Authorization.withRegisteredClient(registeredClient)
				...
				.attribute("scopes", StringUtils.commaDelimitedListToSet(entity.getAuthorizedScopes()))
	...
	private Authorization toEntity(OAuth2Authorization authorization) {
		...
		entity.setAuthorizedScopes(StringUtils.collectionToDelimitedString(authorization.getAttribute("scopes"), ","));
