...
import ai.rnt.auth2.server.repository.OAuthClientRepositoy;

@Service
public class RegisterClientService implements RegisteredClientRepository {

	private final OAuthClientRepositoy clientRepository;
	private final ObjectMapper objectMapper = new ObjectMapper();

	public RegisterClientService(OAuthClientRepositoy clientRepository) {
		Assert.notNull(clientRepository, "clientRepository cannot be null");
		this.clientRepository = clientRepository;

		ClassLoader classLoader = RegisterClientService.class.getClassLoader();
